...
@app.get("/v1/models", dependencies=[Depends(check_api_key)], tags=["chat"])
...
@app.post("/v1/chat/completions", dependencies=[Depends(check_api_key)], tags=["chat"])
...
@app.post("/v1/completions", dependencies=[Depends(check_api_key)], tags=["chat"])
...
@app.post("/v1/embeddings", dependencies=[Depends(check_api_key)], tags=["chat"])
@app.post(
...
@app.post("/api/v1/token_check", tags=["chat"], include_in_schema=False)
...
@app.post("/api/v1/chat/completions", tags=["chat"], include_in_schema=False)
...
@app.post("/v1/chat/count_tokens", dependencies=[Depends(check_api_key)], tags=["chat"])
...
@app.post("/v1/visualize_generation", dependencies=[Depends(check_api_key)], tags=["visualization"])
...
@app.post("/v1/model_architecture", dependencies=[Depends(check_api_key)], tags=["visualization"])
...
@app.post("/v1/layer_details", dependencies=[Depends(check_api_key)], tags=["visualization"])
...
def create_openai_api_server():
    parser = argparse.ArgumentParser(
        description="FastChat OpenAI-Compatible RESTful API server."
    )
